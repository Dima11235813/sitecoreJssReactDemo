...
export default function(manifest) {
  manifest.addComponent({
    ...
    fields: [
      { name: "defaultCardImage", displayName: 'Default Grid Card', type: CommonFieldTypes.Image, standardValue: '<image alt="content card" mediaid="{14478F87-8535-526D-8CAD-3E2D1DD84C2B}" />' },
    ],
    params: [
